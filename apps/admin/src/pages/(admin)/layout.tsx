...
export function Component() {
  ...
  const isHidePadding = hidePaddingPaths.some((path) => location.pathname.includes(path))
    ...
    <SidebarProvider defaultOpen={sidebarState} storage="local">
      ...
      <SidebarInset className="w-full overflow-hidden">
        ...
        <>
          ...
          <ScrollArea className={`flex h-[calc(100vh-5rem)] flex-col gap-4 pt-0 sm:h-[calc(100vh-5rem)] ${isHidePadding ? "p-0" : "p-4 sm:py-6"}`}>
            <Outlet />
