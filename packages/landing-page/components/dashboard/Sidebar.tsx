  ...
  return (
    <div className="min-w-fit">
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-[100dvh] overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 shrink-0 bg-white dark:bg-gray-800 p-4 transition-all duration-200 ease-in-out ${
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block ">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("fintech")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Fintech
                              </span>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block ">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("shop-2")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Shop 2
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("single-product")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Single Product
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("cart-2")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Cart 2
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("cart-3")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Cart 3
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("pay")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Pay
                              </span>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block ">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("users-tabs")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Users - Tabs
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("users-tiles")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Users - Tiles
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("forum-post")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Forum - Post
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("meetups")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Meetups
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("meetups-post")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Meetups - Post
                              </span>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block ">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("cards")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Cards
                              </span>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block ">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("listing")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Listing
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("job-post")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Job Post
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("company-profile")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Company Profile
                              </span>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block ">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("kanban")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Kanban
                              </span>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block ">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("connected-apps")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Connected Apps
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("billing-invoices")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Billing & Invoices
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("give-feedback")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Give Feedback
                              </span>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block ">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("changelog")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Changelog
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("empty-state")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                Empty State
                              </span>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavItem
                              href="https://cruip.com/mosaic/"
                              isActive={pathname.includes("404")}
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100  duration-200">
                                404
                              </span>
