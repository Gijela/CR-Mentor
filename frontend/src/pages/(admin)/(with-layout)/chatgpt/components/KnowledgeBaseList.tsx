          ...
          <div className="px-3 py-2">
            <div className="space-y-1">
              {sortedAndFilteredList.map((kbName) => (
                <div
                  key={kbName}
                  className={`p-2 rounded-lg cursor-pointer flex items-center gap-3 ${currentSelectedKbs.includes(kbName) ?
                      "bg-accent" :
                      "hover:bg-accent/50"
                    }`}
                ...
                >
                  {/* 头像 */}
                  <div
                    className={`flex-shrink-0 rounded-full ${currentSelectedKbs.includes(kbName) ?
                        "bg-primary/10" :
                        "bg-accent"
                      }`}
                  >
