...
// const getDependenciesData = (dependencies: Record<string, string>) =>
...
//   return (
//     <div
//       className={cn("relative flex-1 rounded-md border", className)}
//       style={style}
//     >
//       <div className="h-96 ">
//         <Table>
...
//           total {table.getFilteredRowModel().rows.length} dependencies.
//         </div>
